...
from udp import Porter, PorterStatus, PorterDelegate
...
class Server(dmtp.Server, Logging, PorterDelegate):
    ...
    # Override
    async def _process_command(self, cmd: dmtp.Command, source: SocketAddress) -> bool:
    ...
    # Override
    async def _process_message(self, msg: dmtp.Message, source: SocketAddress) -> bool:
    ...
    # Override
    async def send_command(self, cmd: dmtp.Command, destination: SocketAddress) -> bool:
    ...
    # Override
    async def send_message(self, msg: dmtp.Message, destination: SocketAddress) -> bool:
    ...
    async def send_package(self, pack: Package, destination: SocketAddress, priority: Optional[int] = 0):
